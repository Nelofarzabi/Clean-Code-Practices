...
public class HorizontalFormattingExample {
    ...
    public static int calculateTotalIncome(int baseSalary, int bonus) {
        return baseSalary + bonus;
    }

    public static double calculateNetIncome(int income, int taxRate) {
        return income - (income * (taxRate / 100.0));
    }
}
